...
auth_token ="2fDuezZzzA9Rnb61Y7580Tzuk4K_6hVyR6a4RbHBuqYb8m5o9"
...
api_url = "https://9004-35-199-179-238.ngrok-free.app/"

# Define the text pair for similarity calculation
text_pair = {
    "text1": "text1",
    "text2": "text2"
}
...
response = requests.post(api_url, json=text_pair)
